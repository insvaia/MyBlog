...
- generic palettes
- default purple-blue startup color clich¨¦s
...
- 1 screen ¡ú generate 1 screen image
- 2 screens ¡ú generate 2 screen images
- 3 screens ¡ú generate 3 screen images
- 5 screens ¡ú generate 5 screen images
- 7 screens ¡ú generate 7 screen images
- onboarding flow ¡ú generate multiple onboarding screens, not one
- auth flow ¡ú generate separate sign in / sign up / recovery states when useful
- app concept ¡ú generate a meaningful set, not one isolated hero mockup
...
Examples:
- onboarding ¡ú auth ¡ú home
- home ¡ú browse ¡ú detail
- profile ¡ú settings ¡ú edit profile
- cart ¡ú checkout ¡ú confirmation
- dashboard ¡ú activity ¡ú detail
- welcome ¡ú permissions ¡ú personalized home
