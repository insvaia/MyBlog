...
Allowed layouts:
- `3 ¡Á 3` full identity system
- `2 ¡Á 3` cinematic brand deck overview
- `2 ¡Á 2` compact concept board
- `1 ¡Á 3` horizontal brand strip
- `4 ¡Á 2` wide contact-sheet layout
...
Examples:
- build ¡ú frame, scaffold, block, cursor
- protect ¡ú shield, boundary, watch mark
- convert ¡ú switch, arrow, transformation shape
- speak ¡ú waveform, mic, pulse
- hunt threats ¡ú eye, raptor, radar, trace
- automate ¡ú loop, handoff, path
...
Layout:
[3¡Á3 / 2¡Á3 / custom] grid on a dark or light presentation canvas with strong gutters, clean alignment, and refined negative space.
