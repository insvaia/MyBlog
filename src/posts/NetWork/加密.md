---
title: 加密算法 — 对称加密、非对称加密、摘要
date: 2026-06-26
tags: [Network]
summary: 详解对称加密（DES/3DES）、非对称加密（RSA/DSA）、摘要算法（MD5/SHA1）的原理、优缺点及常见算法对比。
---
...
![对称加密](http://mdrs.yuanjin.tech/img/20211021150521.png)
...
![非对称加密](http://mdrs.yuanjin.tech/img/20211021151158.png)
...
![摘要算法](http://mdrs.yuanjin.tech/img/20211021151642.png)
...
console.log(result); // fc27fb41ca19024555974eb44da26a6f
```
