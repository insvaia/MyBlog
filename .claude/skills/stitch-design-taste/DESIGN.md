...
> **How to use:** Change the numbers above to match your project's vibe. At **Creativity 1每3**, the system produces clean, quiet, Notion-like interfaces. At **Creativity 7每10**, expect inline image typography, dramatic scale contrast, and strong editorial layouts. The rest of the rules below adapt to your chosen levels.
...
## 3. Typography Rules
- **Display:** `Geist`, `Satoshi`, `Cabinet Grotesk`, or `Outfit` 〞 Track-tight (`-0.025em`), controlled fluid scale, weight-driven hierarchy (700每900). Not screaming. Leading compressed (`1.1`). Alternatives forced 〞 `Inter` is BANNED for premium contexts
...
- No AI copywriting clich谷s: "Elevate", "Seamless", "Unleash", "Next-Gen", "Revolutionize"
